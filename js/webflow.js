...
Webflow.require('ix').init([
  ...
  {"slug":"show-and-hide","name":"Show and Hide","value":{"style":{},"triggers":[{"type":"click","selector":".mini-request","siblings":true,"stepsA":[{"display":"block","opacity":1}],"stepsB":[{"display":"none","opacity":0.31,"transition":"opacity 500ms ease 0ms"}]}]}},
  {"slug":"hideshow-horizontal","name":"hideshow_horizontal","value":{"style":{"display":"block","height":"0px"},"triggers":[{"type":"click","stepsA":[{"display":"block","opacity":0.43,"height":"0px","transition":"opacity 500ms ease 0ms, height 500ms ease 0ms"}],"stepsB":[]}]}},
  ...
  {"slug":"modal","name":"modal","value":{"style":{},"triggers":[{"type":"click","selector":".modal-bkgrnd","stepsA":[{"display":"block","opacity":1,"wait":400,"transition":"opacity 500ms ease 0ms"}],"stepsB":[]}]}},
